...
namespace Repository.Migrations
{
    ...
    [Migration("20240102141955_Tables_Relation_Established")]
    partial class Tables_Relation_Established
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Models.Billing", b =>
                {
                    b.HasOne("Entity.Models.Ticket", "Ticket")
                        .WithOne()
                        .HasForeignKey("Entity.Models.Billing", "TicketIdFk")
            ...
            modelBuilder.Entity("Entity.Models.Rate", b =>
                {
                    b.HasOne("Entity.Models.ParkingSpot", "ParkingSpot")
                        .WithOne()
                        .HasForeignKey("Entity.Models.Rate", "ParkingSpotIdFk")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entity.Models.Ticket", b =>
                {
                    b.HasOne("Entity.Models.ParkingSpot", "ParkingSpot")
                        .WithOne()
                        .HasForeignKey("Entity.Models.Ticket", "ParkingSpotIdFk")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entity.Models.Rate", "Rate")
                        .WithOne()
                        .HasForeignKey("Entity.Models.Ticket", "RateIdFk")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
